...
def main():
    ...
    print("""
  ######################################
  # CINE_quotetest Development Environment Setup #
  ######################################

  This script will create your CINE_quotetest dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your CINE_quotetest project folder:
    [Arma 3 installation directory]\\{} => CINE_quotetest project folder
    P:\\{}                              => CINE_quotetest project folder
